...
plt.bar(x,y)
plt.savefig("2a Genre Data in barchart.png",dpi=350,bbox_inches='tight') #save result with resolution accrding me 
plt.xticks(rotation=90,fontsize=10)
plt.savefig("2b Genre Data in barchart.png",dpi=350,bbox_inches='tight')
